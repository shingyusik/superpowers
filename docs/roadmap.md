...
- 모든 Phase는 마지막에 Improvement Agent 호출과 진화 판단을 포함한다.
...
- Main Agent, Improvement Agent, Subagent, Skill, Task, Artifact, Verification의 의미가 명확하다.
...
- workflow 마지막 Improvement Agent 호출 규칙 작성
- 실제 작은 작업에 적용해 보기
...
목표: Improvement Agent가 실제 사용 결과를 바탕으로 하네스를 점진적으로 개선하게 한다.

Improvement Agent의 검토 질문:
...
- 모든 워크플로우 마지막에 Improvement Agent가 호출된다.
...
4. Improvement Agent 초안 작성
5. 작은 실제 작업 하나에 적용
6. Improvement Agent 검토 후 Task Contract 초안 작성
