...
- 모든 Phase는 마지막에 Harness Improvement Agent 호출을 포함한다. MVP에서는 Improve와 Evolve를 나누지 않는다.
...
- 최소 위임 루프 문서화
- task handoff skill 작성
- result report skill 작성
...
- `.agents/skills/task-contract/SKILL.md`
...
- `.agents/skills/verification-report/SKILL.md`
...
2. Task Handoff skill 작성
3. Result Report skill 작성
4. Harness Improvement Agent 초안 작성
5. 작은 실제 작업 하나에 적용
6. Harness Improvement Agent 검토를 반영해 Task Contract 초안 작성
